...
CHROMA_SERVER_AUTHN_PROVIDER = os.environ.get(
    'CHROMA_SERVER_AUTHN_PROVIDER', default=env_values.get('CHROMA_SERVER_AUTHN_PROVIDER'))
CHROMA_CLIENT_AUTHN_PROVIDER = os.environ.get(
    'CHROMA_CLIENT_AUTHN_PROVIDER', default=env_values.get('CHROMA_CLIENT_AUTHN_PROVIDER'))
...
CHROMA_SERVER_AUTHN_CREDENTIALS_FILE = os.environ.get(
    'CHROMA_SERVER_AUTHN_CREDENTIALS_FILE', default=env_values.get('CHROMA_SERVER_AUTHN_CREDENTIALS_FILE'))
...
EMBEDDING_MODEL_NAME = os.environ.get(
    'EMBEDDING_MODEL_NAME', default=env_values.get('EMBEDDING_MODEL_NAME'))
